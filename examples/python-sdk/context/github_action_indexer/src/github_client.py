...
auggie/examples/typescript-sdk/context/github-action-indexer/src/github-client.ts
"""
...
class GitHubClient:
        ...
        with tarfile.open(fileobj=tarball_data, mode="r:gz") as tar:
            for member in tar.getmembers():
                ...
                try:
                    ...
                    filtered_files += 1
                    filter_reasons["binary_file"] = filter_reasons.get("binary_file", 0) + 1
    ...
    def _load_ignore_patterns(
    ...
    ) -> tuple[Optional[pathspec.PathSpec], Optional[pathspec.PathSpec]]:
        """
        ...
        """
        augmentignore: Optional[pathspec.PathSpec] = None
